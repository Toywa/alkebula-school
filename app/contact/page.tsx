...
const trustNotes = [
  ...
  "Suitable for families in Kenya, across Africa and abroad",
];
...
export default function GetMatchedPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const learnerLocation =
        form.city_or_location === "Other / type below"
          ? form.other_location
          : form.city_or_location;

      const detailedMessage = [
        "GET MATCHED WITH A TUTOR REQUEST",
        "",
        `Learner city / location: ${learnerLocation || "Not provided"}`,
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-10 lg:grid-cols-[0.92fr_1.08fr] lg:px-8 lg:py-14">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-slate-600">
              ...
              learning challenge, city and preferred schedule. Alkebula will help
              you narrow the choice toward suitable academic support.
            </p>
          ...
          >
            ...
            >
              ...
              <select
                value={form.city_or_location}
                onChange={(e) =>
                  setForm({
                    ...form,
                    city_or_location: e.target.value,
                    other_location:
                      e.target.value === "Other / type below"
                        ? form.other_location
                        : "",
                  })
                }
                ...
                className="rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm focus:border-[#8F1F36] focus:outline-none focus:ring-2 focus:ring-[#8F1F36]/10"
              >
                <option value="">Learner City / Location</option>
              ...
              {form.city_or_location === "Other / type below" ? (
                <input
                  placeholder="Type learner city / country"
                  value={form.other_location}
                  onChange={(e) =>
                    setForm({ ...form, other_location: e.target.value })
                  }
                  required
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 text-sm leading-7 text-slate-500">
              Location gives helpful context, especially for families comparing
              online support with possible local tutor availability. Timezone
              then helps us plan lessons at realistic hours.
            </p>
          </div>
      ...
      <section className="bg-white px-6 py-12 lg:py-16">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-slate-200 bg-gradient-to-br from-white via-[#FFFDFB] to-[#FFF5F7] p-8 text-center shadow-sm lg:p-10">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600">
            ...
            location, exam window and current academic need. The Alkebula team
            will review it and guide the next step.
          </p>
